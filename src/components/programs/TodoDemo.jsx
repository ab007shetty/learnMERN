...
// Immutable lines shown above and below the editable area
...
const TodoDemo = ({ icon: Icon, name, description }) => {
          ...
          <div className="w-full lg:w-1/2 flex flex-col h-auto min-h-0">
            ...
            <div className="p-6 md:p-8 border-b border-gray-200">
              <div className="flex items-center space-x-4 mb-4">
                ...
                <div>
                  <h2 className="text-2xl font-bold text-gray-900">{name || "ToDo"}</h2>
