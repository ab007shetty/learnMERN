const coreJsQuestions = [
  {
    ...
    answer: [
      "Prefer const by default since it prevents accidental reassignments.",
      "Use let only when a variable’s value truly needs to change like reassignments.",
      "Avoid var since it is function-scoped, hoisted with undefined, so prone to bugs.",
      "Always declare variables at the top of their block to avoid TDZ.",
    ],
    example: [
      "      | Scope          | Hoisting          | Reassign    | Redeclare",
      "------|----------------|-------------------|-------------|------------",
      "var   | Function scope | Yes (undefined)   | Allowed     | Allowed",
      "let   | Block scope    | Yes (TDZ applies) | Allowed     | Not allowed",
      "const | Block scope    | Yes (TDZ applies) | Not allowed | Not allowed",
    ],
    keyterms: [
      "Scope = area where variable is accessible (function or block)",
      "Hoisting = variables moved to top of scope before execution",
      "TDZ (Temporal Dead Zone) = period after hoisting but before initialization; accessing variable throws error",
    ],
  },
  {
    id: 2,
    ...
    example: [
      "      | Hoisted? | Initialized? | TDZ  | Access Before Declaration",
      "------|----------|--------------|------|---------------------------",
      "var   | Yes      | Yes (undef)  | No   | Allowed (undefined)",
      "let   | Yes      | No           | Yes  | Error in TDZ",
      "const | Yes      | No           | Yes  | TDZ + Must initialize ",
    ],
  },
  {
    id: 3,
    question:
      "How do var, let, and const differ in terms of hoisting, scope, redeclaration, and reassignment?",
    answer: [
      "var is hoisted and initialized as undefined; let and const are hoisted but remain in the temporal dead zone until declared.",
      "var has function/global scope, while let and const are block-scoped.",
    ...
    example: [
      ...
      "try { console.log(b); } catch(e) { console.log('b error:', e.message); }",
      "try { console.log(c); } catch(e) { console.log('c error:', e.message); }",
      "var a = 10;",
      "let b = 20;",
      "const c = 30;",
      " ",
      ...
      "}",
      "console.log(x); // works",
      "try { console.log(y); } catch(e) { console.log('y error:', e.message); }",
      "try { console.log(z); } catch(e) { console.log('z error:', e.message); }",
      " ",
      "var name = 'A';",
      "var name = 'B'; // ✅ redeclaration allowed",
      "",
      "let city = 'Paris';",
      "// let city = 'London'; // ❌ not allowed",
      "city = 'London'; // ✅ allowed",
      "",
      "const country = 'India';",
    ...
    keyterms: [
      "Hoisting = variable declarations moved to top before execution",
      "TDZ (Temporal Dead Zone) = phase where let/const exist but are not initialized",
      "Scope = defines where a variable is accessible",
      "Redeclare = define the same variable name again in the same scope",
  ...
  },
  {
    ...
    keyterms: [
      ...
      "TCO (Tail Call Optimization) = not reliable in JS",
    ],
  },
  {
    id: 6,
  ...
  },
  {
    ...
    answer: [
      ...
      "To trigger a default param, you must pass `undefined` explicitly.",
    ...
    keyterms: [
      ...
      "Rest params = variable arity",
      "undefined = triggers default param",
    ],
  },
  {
    id: 9,
  ...
  },
  {
    ...
    keyterms: [
      "TDZ = period between a variable’s hoisting and its initialization.",
  ...
  },
  {
    ...
    example: [
      ...
      "run(greet); // 'Hello'",
      " ",
      "// immediately invoking a return function",
      "function outer() { return () => 'Inner'; }",
      "console.log(outer()()); // 'Inner'",
    ],
    keyterms: [
      "First-class citizens = treated like values",
      "Functions = assign, pass, return, store",
    ],
  },
  {
    id: 12,
  ...
  },
  {
    ...
    answer: [
      ...
      "It uses ()() syntax → one pair for wrapping, one pair for execution.",
    ],
    example: [
      "(function() {",
    ...
    keyterms: ["IIFE = Function that executes immediately after creation"],
  },
  {
    id: 16,
    question: "What is Function Currying?",
    answer: [
      "Currying means breaking a function that takes multiple arguments into a chain of functions, each taking one argument at a time.",
    ...
    keyterms: [
      ...
      "Partial application → pre-fill some args, not necessarily one at a time",
    ],
  },
  {
    id: 17,
  ...
  },
  {
    ...
    answer: [
      ...
      "Higher-order functions (HOF): A function that takes one or more functions as arguments (callbacks), or returns a function.",
      "The function passed as an argument is called a callback, and the function receiving it is called the higher-order function.",
    ],
    example: [
      ...
      "};",
      " ",
      "console.log(calculate(radius, area)); // [28.27, 3.14, 12.56, 50.27]",
    ],
    keyterms: [
      "First-class = functions as values (assign, pass, return)",
      "Higher-order = takes/returns functions",
      "Callback = function passed to HOF",
      "DRY principle = Don't Repeat Yourself (reuse logic)",
    ],
  },
  {
    id: 23,
  ...
  },
  {
    ...
    answer: [
      ...
      "It executes later, typically after an operation completes.",
      "Common use cases: timers (setTimeout), event listeners, network requests, and sequencing async tasks.",
      "Callbacks enable async programming and support event-driven designs in JavaScript.",
    ],
    example: [
    ...
    keyterms: [
      ...
      "Async flow = sequencing tasks without blocking",
    ],
  },
  {
    id: 25,
    ...
    answer: [
      ...
      "Arrow functions don't have their own `arguments`; use rest `...args` instead.",
      "Arrow functions are shorter and support implicit return.",
    ],
    example: [
      "const user = {",
      "  name: 'Ani',",
      ...
      "user.arr(); // undefined",
      " ",
      "function regular(a, b) { console.log(arguments[0]); }",
      "regular(1, 2, 3); // 1",
      " ",
    ...
    keyterms: [
      ...
      "Dynamic this = regular depends on caller",
      "No arguments in arrow; use rest params",
    ],
  },
  {
    id: 26,
  ...
  },
  {
    ...
    example: [
      ...
      "fn(); // 'hidden'",
      " ",
      "// outer returns the arrow function and that is assigned to fn",
      "// After return outer func's FEC removed from call stack",
    ],
    keyterms: [
  ...
  },
  {
    ...
    answer: [
      ...
      "Cons: Memory retention, Potential performance issues, Harder debugging",
    ],
    example: [
    ...
    keyterms: [
      ...
      "Encapsulation = hiding variables from outside scope",
      "Stateful function = function remembers values between calls",
      "Modularity = reusable code pattern (callbacks, factories, event handlers)",
      "Memory retention = closures keep referenced variables alive in memory",
      "Performance issue = holding large data unnecessarily can slow down app",
      "Debugging difficulty = harder to trace variables that live longer than expected",
      "GC (Garbage Collection) = automatic memory cleanup by JS engine",
    ],
  },
  {
    id: 29,
    ...
    answer: [
      ...
      "Only returned methods (increment, decrement, get) can access and modify the private variable.",
      "Encapsulation is achieved by exposing behavior instead of raw state.",
    ],
    example: [
      "function bank(){",
      "  let balance = 0;",
      "  return {",
      "    deposit(amount){ balance += amount; },       // shorthand method",
      "    withdraw: (amount) => balance -= amount,     // arrow function method",
      "    get: function(){ console.log(balance); }     // normal function",
      "  };",
      "}",
      " ",
      "const account = bank();",
    ...
    keyterms: [
      ...
      "Privileged methods = controlled access to private data",
      "Closure = inner function keeps access to outer scope",
    ],
  },
  {
    id: 30,
  ...
  },
  {
    ...
    answer: [
      "Debounce: delay execution until user stops triggering. waits for user to stop typing before running.",
      "Throttle: limit executions to once per interval. Runs at regular intervals no matter how much user types.",
    ...
    keyterms: [
      "Debounce = Run after calm down",
      "Throttle = Run once per time slot",
    ],
  },
  {
    id: 39,
  ...
  },
  {
    ...
    answer: [
      ...
      "UI freezes and DOM will not load if that piece of code comes at the beginning, thereby degrading user experience.",
      "Use async patterns or Web Workers or execute that piece of code later when DOM loads properly to avoid blocking.",
    ],
    example: [
      "console.log('Main thread blocking started');",
      " ",
      "const start = Date.now();",
      "while (Date.now() - start < 5000) {",
      "  // blocks Main Thread for 5 sec",
      "}",
      " ",
    ...
    keyterms: [
      ...
      "Web Workers = Background scripts that run in parallel with main thread",
    ],
  },
  {
    id: 42,
    ...
    answer: [
      ...
      "It constantly checks the call stack and queues to decide what to execute next, as soon as call stack becomes empty.",
      "Microtask Queue: higher-priority queue for promises, MutationObserver, and queueMicrotask. Runs right after the current call stack is empty.",
      "Callback/Task Queue: lower-priority queue for tasks like setTimeout, setInterval, DOM events, and network callbacks. Runs only after microtasks finish.",
      "Concurrency Model: how JS manages multiple tasks without parallel threads, with the help of Event Loop which schedules task bw call stack and queues.",
    ],
    example: [
      "console.log('Start');",
      " ",
      ...
      " ",
      "// Output order:",
      "// Start → End → Promise Resolved → Task Queue: Timeout",
    ],
    keyterms: [
      "Event Loop = decides execution order of tasks",
      "Call Stack = executes synchronous code",
      "Microtask Queue = promises, MutationObserver (high priority)",
      "Callback/Task Queue = setTimeout, events, I/O (lower priority)",
      "Order = synchronous code → microtasks → tasks (callbacks).",
    ],
  },
  {
    id: 43,
    ...
    answer: [
      "Microtask Queue has higher priority — promises, MutationObserver, and queueMicrotask go here.",
      "Callback/Task Queue is lower priority — setTimeout, setInterval, DOM events, and other async APIs go here.",
      "After each synchronous code execution, the event loop empties the Microtask Queue before moving to the Callback/Task Queue.",
      "This ensures promises resolve before timeouts and DOM callbacks.",
    ],
    example: [
      "let fn = () => console.log('callback func');",
      "setTimeout(fn, 1);",
      " ",
...

  {
    ...
    example: [
      ...
      "  setTimeout(() => console.log('Hello from Callback!'), 1000);",
      "  console.log('Start');",
      "}",
      "callbackDemo(); ",
      " ",
      "// Output: 'Start' →  'Hello from Callback!' after 1s",
    ],
  ...
  },
  {
    ...
    example: [
      "console.log('start');",
      " ",
      "const promiseDemo = new Promise(resolve =>",
      ...
      "console.log('end');",
      " ",
      "// Output: start → end → Promise resolved (after 1s delay)",
    ],
  ...
  },
  {
    ...
    answer: [
      "async/await pauses execution until a Promise resolves, making async code look synchronous and easier to read than chaining .then() with Promises.",
      "Code after await (or after calling the async function) can run immediately, demonstrating async behavior.",
      "Explanation of example:",
      "1. `wait(ms)` returns a Promise that resolves after `ms` ms.",
      "2. `await wait(1000)` pauses the async function for 1 second.",
      "3. Errors can be handled with try/catch (optional if using .catch() outside).",
    ],
    example: [
      "console.log('start');",
      " ",
      ...
      "console.log('end');",
      " ",
      "// Output: start → end → Async/Await resolved (after 1s delay)",
    ],
  ...
  },
  {
    ...
    answer: [
      ...
      "Promises: Provide a cleaner async model by flattening the structure with .then() chaining, improving readability",
      "Async/await: Built on promises, makes async code look synchronous, avoiding chaining entirely, gives sync-like code and better readability.",
    ],
    example: [
  ...
  },
  {
    ...
    answer: [
      "Starvation happens when tasks in the Callback/Task Queue (like setTimeout, events) keep getting delayed.",
      "This occurs if microtasks (promises, MutationObserver) continuously create new microtasks.",
      "Since the event loop always empties the Microtask Queue before moving to the Callback Queue, endless microtasks can starve callback tasks.",
      "This leads to timers, DOM events, or I/O callbacks being blocked indefinitely.",
    ],
    example: [
      "console.log('Start');",
      " ",
      ...
      "    endlessMicrotask(); // schedules another microtask endlessly",
      "  });",
      "}",
      " ",
      "endlessMicrotask();",
      ...
      " ",
      "// Output:",
      "// Start → Microtask running → Microtask running → ... (infinite)",
      "// Timeout never runs (starved)",
    ],
    keyterms: [
      "Starvation = when lower-priority tasks never get CPU time",
      "Microtask Queue = higher priority, can block tasks if abused",
...

  {
    ...
    answer: [
      "A Promise is an object that represents the eventual completion, either success or failure of an asynchronous task.",
    ...
    keyterms: [
      "Inversion of control = when you give control of your code to another function (like a callback inside async function).",
      "Callback hell = when many callbacks are nested inside each other, making code hard to read and manage.",
    ],
  },
  {
    id: 50,
    ...
    keyterms: ["immutable = cannot change once settled"],
  },
  {
    id: 51,
  ...
  },
  {
    ...
    example: [
      "const API_URL = 'https://api.github.com/users/ab007shetty';",
      " ",
      "async function fetchUser() {",
      "  const res = await fetch(API_URL);   // 1️Wait for the fetch request to complete",
      "  const data = await res.json();      // 2️Wait for the body to be parsed as JSON",
      "  console.log(data);",
      "}",
      " ",
      "fetchUser();",
  ...
  },
  {
    ...
    answer: [
      ...
      "Promise.any fulfills when the first promise resolves successfully, ignoring rejections. ",
    ],
    example: [
  ...
  },
  {
    ...
    example: [
      ...
      "<div onclick='this.style.background=\"yellow\"'>\n" +
        "  Click to Highlight\n" +
        "</div>",
    ],
...

  {
    ...
    example: [
      ...
      "}",
      " ",
      "greet.call(person, 'Udupi', 'India');  ",
      "greet.apply(person, ['Udupi', 'India']); ",
...

  {
    ...
    answer: [
      "'bind()' lets us permanently fix, 'this' for a function.",
  ...
  },
  {
    ...
    answer: [
      ...
      "Commonly used for data transformation, like extracting fields or converting values.",
    ],
    example: [
    ...
    keyterms: [
      ...
      "Returns new array = same length as input",
      "Pure function = no mutation of original array",
    ],
  },
  {
    id: 65,
    ...
    keyterms: [
      "filter = pick elements matching condition",
      "Returns new array = length ≤ original",
  ...
  },
  {
    ...
    answer: [
      ...
      "Takes two arguments: a callback (with accumulator and current value) and an initial value.",
      "Common use cases: sum, average, max/min, object grouping.",
    ],
    example: [
      ...
      " ",
      "const maxVal = prices.reduce((max, curr) => curr > max ? curr : max, 0);",
      "console.log(maxVal); // 15",
    ],
    keyterms: [
      "reduce = compress array into single value",
  ...
  },
  {
    ...
    answer: [
      "A polyfill is custom code that adds support for a feature if it is not available in a browser.",
      "Polyfills ensure older environments can still use modern array methods.",
      "For map, filter, and reduce, polyfills mimic their original behavior using for-loops.",
    ],
    example: [
      "// Polyfill for map",
      " ",
    ...
    keyterms: [
      "Polyfill = custom implementation of a feature",
      "Needed for backward compatibility",
      "Implemented by extending prototypes (like Array.prototype)",
    ],
  },
  {
    id: 68,
    ...
    example: [
      "function memoize(fn) {",
      "  const c = {};",
      "  return x => c[x] ?? (c[x] = fn(x));",
      "}",
      " ",
      "// Real world: discount calculation",
      "const discount = memoize(p => p * 0.10);",
      " ",
      "discount(500);  // slow first time",
      "discount(500);  // fast (from cache)",
    ],
    keyterms: [
      "Cache = stored output",
      "Closure = remembers variable",
  ...
  },
  {
    ...
    answer: [
      "Both paradigms exist in JavaScript, but functional programming is more common in day-to-day code.",
      "JavaScript treats functions as first-class citizens, making it natural to use map, filter, reduce, callbacks, and promises.",
      "OOP (with classes/objects) is still used, especially for structuring large applications and frameworks (like React classes before hooks).",
      "Modern JS often uses a mix: functional style for data handling, OOP for app architecture.",
    ],
    example: [
      "// Functional style",
      ...
      " ",
      "const c = new Counter();",
      "c.inc(); console.log(c.value); // 1",
    ],
    keyterms: [
      "Functional programming = uses functions as primary building blocks",
      "OOP = organizes code into objects/classes",
      "JavaScript = multi-paradigm (supports both)",
    ],
  },
  {
    id: 70,
    ...
    answer: [
      "OOP in JavaScript is a programming paradigm where data (objects) and behavior (methods) are bundled together.",
      "JS supports OOP using prototypes and classes.",
      "The 4 key principles are: Encapsulation, Abstraction, Inheritance, and Polymorphism.",
    ],
    keyterms: [
      "OOP = programming paradigm combining data and behavior in objects",
      "Encapsulation = binding data with methods and keeping them private",
      "Abstraction = hiding implementation details and exposing only necessary interfaces",
      "Inheritance = reusing properties/methods from parent objects",
      "Polymorphism = ability of a method to take multiple forms depending on context",
    ],
  },
  {
    id: 71,
    ...
    answer: [
      ...
      "Achieved using closures or private fields (#) inside classes.",
    ],
    example: [
      "class BankAccount {",
      "  #balance = 0;",
    ...
    keyterms: [
      "Private field = variable not directly accessible",
  ...
  },
  {
    ...
    answer: [
      ...
      "In JS, achieved via abstract base classes or by designing APIs that hide implementation.",
    ],
    example: [
      "class Car {",
      "  start() { console.log('Car started'); }",
      "  stop() { console.log('Car stopped'); }",
      "  // details like fuel injection are hidden",
      "}",
      " ",
      "const c = new Car();",
      "c.start(); // Car started",
    ...
    keyterms: [
      ...
      "API design = practical abstraction",
    ],
  },
  {
    id: 73,
    ...
    answer: [
      ...
      "In JavaScript, achieved using 'extends' keyword with classes or Object.create with prototypes.",
    ],
    example: [
      "class Animal {",
    ...
    keyterms: [
      ...
      "Prototype chain = mechanism behind inheritance",
    ],
  },
  {
    id: 74,
    ...
    answer: [
      ...
      "In JavaScript, achieved by method overriding or using dynamic typing.",
    ],
    example: [
      ...
      "}",
      " ",
      "console.log(new Circle(3).area()); // 28.27",
      "console.log(new Square(4).area()); // 16",
    ],
    keyterms: [
      "Polymorphism = multiple forms of same method",
  ...
  },
  {
    ...
    answer: [
      "Functions can be used with `new` as constructors to create object instances.",
      "Methods can be placed on `FunctionName.prototype` to share across all instances, saving memory.",
      "Each instance can still have its own properties, but methods on prototype are shared.",
    ],
    example: [
    ...
    keyterms: [
      ...
      "Prototype = object shared among all instances",
      "Prototype chain = lookup path JS uses for inherited properties/methods",
    ],
  },
  {
    id: 76,
    ...
    answer: [
      ...
      "JS internally uses prototypal inheritance, though `class` syntax is syntactic sugar.",
    ],
    example: [
      "// Classical style",
    ...
    keyterms: [
      "Prototype = parent object from which others inherit",
      "Prototype chain = path JS uses to look up inherited properties",
      "Classical inheritance = class-based, blueprint-like inheritance",
  ...
  },
  {
    ...
    answer: [
      ...
      "When added to the prototype, the method becomes available to all instances of that object type.",
      "It allows extending JavaScript’s core objects, though modifying built-in prototypes in production is generally discouraged.",
    ],
    example: [
    ...
    keyterms: [
      ...
      "Prototyping = extending core objects with new methods",
  ...
  },
  {
    ...
    example: [
      "const user = {",
      "  name: 'Ani',",
      "  sayHi() { console.log('Hi ' + this.name); },       // shorthand",
      "  arrowHi: () => console.log('Hi ' + this.name),     // arrow method ",
      "  normalHi: function() { console.log('Hello ' + this.name); } // normal",
      "};",
      " ",
      "user.sayHi();    // 'Hi Ani'",
      "user.arrowHi();  // 'Hi undefined' in strict mode. coz (no own this)",
  ...
  },
  {
    ...
    answer: [
      ...
      "Smart garbage collection can detect variables inside closures that are no longer used and release them, even if the closure itself exists.",
      "This prevents memory leaks in long-running applications where closures retain references unnecessarily.",
      "Smart collectors optimize performance by reducing memory usage without waiting for the entire closure to go out of scope.",
    ],
    example: [
      "function createCounter() {",
      "  let count = 0; // local variable inside closure",
      "  return function() {",
      "    console.log('Incremented'); // 'count' is never used",
      "  };",
      "}",
      " ",
      "const counter = createCounter();",
      "counter();",
      "// Modern garbage collectors may free 'count' memory since it's not used",
    ],
    keyterms: [
      "Garbage Collector = automatically frees memory for unreachable objects, Uses mark-and-sweep;",
      "Closure = hinder by retaining references.",
      "Smart GC = detects unused variables inside closures and cleans them early",
      "Memory Leak = retained memory that is no longer needed",
    ],
  },
  {
    id: 83,
  ...
  },
  {
    ...
    answer: [
      ...
      "It has two phases: Mark and Sweep.",
      "Mark phase: all reachable objects are marked as 1 using DFS traversal.",
      "Sweep phase: objects still marked as 0 are deleted from heap memory.",
      "After sweeping, all reachable objects are reset to 0 for the next cycle.",
    ],
    keyterms: [
      "Mark phase = identifies reachable objects via DFS",
      "Sweep phase = removes unreachable objects",
      "Heap memory = memory area where objects are stored",
      "DFS (Depth-First Search) = traversal method used to mark reachable objects",
      "Tracing GC = garbage collector that works by tracing object references",
    ],
  },
  {
    id: 86,
    ...
    answer: [
      "JavaScript is a high-level language that is both interpreted and compiled (Just-In-Time compilation).",
      "V8 engine first parses JS code into an Abstract Syntax Tree (AST) to understand the program structure.",
      "Ignition, the interpreter, converts the AST into bytecode and starts execution quickly (baseline performance).",
      "Turbofan, the optimizing compiler, monitors running code and compiles hot functions into highly optimized machine code for faster execution.",
      "This pipeline allows JavaScript to start running immediately while still achieving high performance for frequently used code.",
    ],
    example: [
      "// JS code",
      "let sum = (a, b) => a + b;",
      ...
      "// 2. Ignition Interpreter → generates bytecode and executes",
      "// 3. Turbofan Compiler → optimizes hot code into machine code",
    ],
    keyterms: [
      "Compiled vs Interpreted = JS uses JIT compilation (both)",
      "Parser = converts code into Abstract Syntax Tree (AST)",
      "AST = tree representation of code structure",
      "Ignition = baseline interpreter producing bytecode",
      "Turbofan = optimizing compiler for hot code",
      "Bytecode = low-level instructions executed by V8",
    ],
  },
  {
    id: 87,
    ...
    answer: [
      "Mark-and-Sweep: Garbage collector marks reachable objects and deletes unmarked ones to free memory.",
      "Inlining: Functions are replaced by their body in hot code to reduce call overhead.",
      "Copy Elision: Avoids unnecessary copying of objects/values when returning or passing them.",
      "Inline Caching: Caches property access patterns for faster repeated object property lookups.",
    ],
    example: [
      "// Mark-and-Sweep",
      "let obj = {a: 1};",
      "obj = null; // unreachable → collected by GC",
      " ",
      "// Inlining",
      "function add(a,b){ return a+b; }",
      "// JS engine may replace add(x,y) with x+y",
      " ",
      "// Copy Elision",
      "function createPoint(){ return {x:0, y:0}; }",
      "// engine avoids extra copying of object",
      " ",
      "// Inline Caching",
      "let obj = {name:'Ani'};",
      "console.log(obj.name);",
      "// engine caches property lookup for speed",
    ],
    keyterms: [
      "Mark-and-Sweep = GC deletes unreachable memory",
      "Inlining = replaces function calls with body",
      "Copy Elision = avoids unnecessary copies",
      "Inline Caching = caches property access paths for speed",
    ],
  },
  {
    id: 88,
    ...
    answer: [
      "Web Worker runs background threads for heavy computations (keeps UI responsive).",
      "Service Worker acts as a proxy between browser & network (handles caching, offline support, push notifications).",
      "Web Worker has no direct access to DOM, Service Worker also cannot access DOM but can intercept network requests.",
      "Web Worker ends when the page is closed, Service Worker persists beyond page (event-driven, works even when page is closed).",
    ],
    example: [
      "// Web Worker Example",
    ...
    keyterms: [
      "Web Worker = Background thread for computation",
  ...
  },
  {
    id: 90,
    question:
      "What are factory functions, why do we need them, and how do they differ from normal functions?",
    answer: [
      "Factory functions are functions that **create and return new objects**.",
      "They help **generate multiple instances** with similar properties without using classes.",
      "They are useful for **encapsulation, reusability, and object creation**.",
      "Normal functions perform actions or calculations and may return values, but **do not necessarily create new object instances**.",
    ],
    example: [
      "// Factory function",
    ...
    keyterms: [
      ...
      "Normal function = performs a task or calculation",
      "Encapsulation = hide details inside function",
      "Reusability = create multiple objects easily",
      "Object instance = each call returns a separate object",
    ],
  },
  {
    id: 92,
    question:
      "Write real-time implementation examples of array methods such as map, filter, every, and reduce in a React project.",
    answer: [
      "Array methods are used to manipulate and render data efficiently in React.",
      "They help in transforming arrays for UI rendering, filtering lists, checking conditions, and aggregating data.",
    ],
    example: [
      "// Sample data",
      "const users = [",
      ...
      "];",
      " ",
      "// map: render list of user names",
      "const userNames = users.map(u => <p key={u.id}>{u.name}</p>);",
      " ",
      ...
      " ",
      "// reduce: get total age of users",
      "const totalAge = users.reduce((sum, u) => sum + u.age, 0);",
    ],
    keyterms: [
      "map = transform array into new array or JSX elements",
  ...
  },
  {
    ...
    answer: [
      ...
      "undefined is the default state; null is a manually assigned placeholder.",
      "typeof undefined is 'undefined', typeof null is 'object' (JS bug).",
      "undefined often means 'not available', while null means 'empty on purpose'.",
    ],
    example: [
      "// Undefined examples",
      "let a;",
      ...
      " ",
      "function test(x) {",
      "  console.log(x); // undefined if no argument passed",
      "}",
      "test();",
      " ",
      "// Null examples",
  ...
  },
  {
    id: 94,
    question:
      "What is event delegation, and why is it efficient in large DOM trees?",
    answer: [
      "Event delegation means attaching a single event listener to a parent instead of multiple children.",
      "The parent listens to events bubbling up from its child elements.",
      "It improves performance because fewer listeners means less memory usage.",
      "It works best in dynamic UIs where child elements are created or removed frequently.",
      "Helps avoid attaching listeners every time new elements are added.",
    ],
    example: [
    ...
    keyterms: [
      ...
      "Delegation = parent handles child's events.",
      "Efficient DOM = fewer listeners improve performance.",
    ],
  },
  {
    id: 95,
    question:
      "What are Event Bubbling, Event Capturing, and Event Delegation in JavaScript?",
    answer: [
      "Event Bubbling: the event triggers on the target element first, then moves upward through its parent elements.",
      "Event Capturing: the event travels from the outermost parent to the target element before bubbling starts.",
      "Browser uses bubbling by default unless capture: true is used.",
      "Event Delegation: instead of adding listeners to many child elements, you attach one listener to a parent and detect which child triggered the event.",
      "Event Delegation improves performance in large DOM trees because fewer listeners are created and DOM updates don’t require re-attaching listeners.",
    ],
    example: [
      ...
      ");",
      " ",
      "// Clicking child → Parent(capture) → Child",
      " ",
      "/* Event Delegation Example */",
      ...
      "});",
      " ",
      "// Works even if LIs are added later dynamically",
    ],
    keyterms: [
      "Bubbling = child → parent flow",
      "Capturing = parent → child flow",
      "capture: true = enables capturing phase",
      "Event Delegation = one parent handler manages multiple child events",
      "Efficient = fewer listeners, works with dynamic elements",
    ],
  },
  {
    id: 96,
    question:
      "What are some important Set and Array methods in JavaScript, and how are they used?",
    answer: [
      "Set methods allow you to store unique values and perform fast lookups.",
      "Array methods can be combined with Set for operations like removing duplicates, union, intersection, and difference.",
      "Key operations include add(), delete(), has(), clear(), size for Set, and filter(), concat(), includes(), Array.from(), and spread operator [...] for arrays.",
    ],
    example: [
      "// Remove duplicates",
      "const nums = [1,2,2,3];",
      ...
      " ",
      "// Intersection",
      "const intersection = a.filter(x => new Set(b).has(x));",
      "console.log(intersection); // [2]",
      " ",
      "// Difference",
      "const difference = a.filter(x => !new Set(b).has(x));",
  ...
  },
  {
    id: 97,
    question:
      "Can a Set be used to convert a string into an array in JavaScript? How does it work?",
    answer: [
      "Yes. A string can be converted into an array using a Set because strings are iterable.",
      "Each character in the string becomes an element of the Set.",
      "Duplicates are automatically removed by the Set.",
      "The Set can then be converted back into an array using the spread operator [...] or Array.from().",
    ],
    example: [
      "const str = 'hello';",
      ...
      " ",
      "// Explanation:",
      "// 'hello' → iterable → Set becomes {'h','e','l','o'} → duplicates removed",
      "// Spread converts Set back to array.",
    ],
    keyterms: [
      "Iterable = a type of object that can be looped over (string, array, Set, Map)",
      "Set = collection of unique values",
      "Spread operator [...] = converts iterable into array",
      "Duplicates = automatically removed by Set",
    ],
  },
  {
    id: 98,
    question: "How to convert a callback function into a Promise?",
    answer: [
      "Wrap the callback function inside a new Promise constructor.",
      "Call resolve inside the success callback and reject inside the error callback.",
      "This allows using async/await syntax instead of nested callbacks.",
    ],
    example: [
    ...
    keyterms: [
      ...
      "Promise = object representing a future value or error",
  ...
  },
  {
    ...
    answer: [
      "Await converts the value into a resolved promise automatically.",
      "The code pauses until the value is ready, but non-promises resolve immediately.",
      "Useful for writing consistent async code without worrying about whether a value is a promise or not.",
    ],
    example: [
      "async function test() {",
    ...
    keyterms: [
      "await = pauses async function until the promise resolves",
      "non-promise value = automatically wrapped in resolved promise",
    ],
  },
  {
    id: 100,
    ...
    answer: [
      ...
      "Supports modern JavaScript features and compiles down to plain JavaScript for browsers.",
    ],
    example: [
    ...
    keyterms: [
      ...
      "Compile-time = errors are caught before running code",
      "Superset = extends JavaScript with additional features",
    ],
  },
  {
    id: 101,
    question: "Why do we use generic functions in TypeScript?",
    answer: [
      "Generics allow writing reusable functions, classes, or interfaces that work with any type.",
      "They provide type safety while keeping flexibility.",
      "Avoids using 'any', ensuring consistent type checks at compile time.",
    ],
    example: [
    ...
    keyterms: [
      "Generic = reusable component for multiple types",
      "Type safety = ensures correct type usage at compile time",
    ],
  },
];
