const coreJsQuestions = [
  ...
  },
  {
    ...
    example: [
      "      | Hoisted? | Initialized? | TDZ Exists? | Access Before Declaration",
      "------|----------|--------------|-------------|---------------------------",
  ...
  },
  {
    id: 15,
    question:
      "What is an IIFE (Immediately Invoked Function Expression) and how is it different from function currying?",
    answer: [
      "IIFE is a function that runs immediately after being defined.",
      "It uses ()() syntax → one pair for wrapping, one pair for execution.",
      "Function currying is when a function returns another function and parameters are passed step by step.",
      "Syntax looks similar, but currying delays execution until further calls.",
    ],
    example: [
      "// Example 1: IIFE",
      " ",
    ...
    keyterms: [
      "IIFE = Function that executes immediately after creation",
      "Currying = Breaking a function with multiple params into nested functions",
      "()() = Syntax used for both, but purpose differs",
    ],
  },
  {
    id: 16,
  ...
  },
  {
    ...
    example: [
      ...
      "  let count = 0; // private",
      "  return {",
      "    increment(){ count++; },                 // shorthand method",
      "    doubleIncrement: () => count += 2,      // arrow function method",
      "    get: function(){ return count; }       // with 'function' keyword",
      "  };",
      "}",
      " ",
  ...
  },
  {
    ...
    example: [
      ...
      " ",
      "// Output order:",
      "// Start → End → Microtask Queue: Promise → Task Queue: Timeout",
    ],
    keyterms: [
...

  {
    ...
    example: [
      ...
      "callbackDemo(); ",
      " ",
      "// Output: 'Start' immediately, then 'Hello from Callback!' after 1s",
    ],
  ...
  },
  {
    ...
    example: [
      ...
      "  setTimeout(() => res('Hello from Promise!'), 1000)",
      ");",
      " ",
      "promiseDemo",
  ...
  },
  {
    ...
    example: [
      "function wait(ms) {",
      "  return new Promise(res => setTimeout(() => res('async/await!'), ms));",
      "}",
      " ",
      ...
      "console.log('Start'); ",
      " ",
      "// Output: 'Start' immediately, then 'async/await!' after 1s",
    ],
